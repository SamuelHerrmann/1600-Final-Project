...
This page is ment to teach you some of the basic syntax included with the Markdown coding language.

# Headings

To make headings simply type "# (your text)". Adding additional #'s will decrease the size of your heading to a maximum of 6 #.
This syntax needs to have an empty line both above and below the line you wish to make a heading.

# Paragraphs and Regular Text

To make paragraphs and regular text simply type in an empty line of code.
